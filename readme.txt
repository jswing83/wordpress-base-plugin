...
* PHP 5.6 or higher
* [Carbon Fields](https://github.com/htmlburger/carbon-fields) 2.0 or higher (see the wiki section on [Carbon Fields](https://github.com/dmhendricks/wordpress-test-plugin/wiki#carbon-fields) for more info)
...
2. Clone the repository: `git clone https://github.com/dmhendricks/wordpress-test-plugin.git`
3. Renamed the newly created `wordpress-test-plugin` directory to your own plugin slug.
...
A. You need to use the command prompt and [run Composer](https://github.com/dmhendricks/wordpress-test-plugin#composer) before this plugin will work.
